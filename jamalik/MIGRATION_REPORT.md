...
**واسم الموقع لم يُغيَّر** («جمالِك») — الهوية البصرية خارج نطاق هذه المهمة صراحةً.
...
| `tests/e2e.mjs` | مسارات الاختبار تُشتقّ من المحتوى الحيّ |
...
`RUN_SEED=true` في Vercel ← أعيدي النشر ← ثم **احذفي المتغيّر**.

سيُنفّذ البناء بالترتيب: الهجرات ← التعبئة (٣٨ مقالًا + إزالة المحتوى التجريبي)
← تنزيل الصور الثمانية والثلاثين ← بناء الصفحات.
